...
// Функция для расчета заработной платы для второго сотрудника
void calculate_ZP2(double hours2, double payment2, double prem_percent2,
...
int main () {
    ...
    calculate_ZP2(hours2, payment2, prem_percent2, total_ZP2, nalog2, net_ZP2);
